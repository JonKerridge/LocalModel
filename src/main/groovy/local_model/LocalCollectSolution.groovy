...
class LocalCollectSolution implements CSProcess{
  ...
  @Override
  void run() {
    LocalProblemSpecification spec
...
//      println "Collect: reading specification $i"
      spec = input.read() as LocalProblemSpecification
      ...
      seedValue = result[0]
      LocalIndividual bestOutcome = result[1]
